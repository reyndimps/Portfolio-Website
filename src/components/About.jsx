        ...
        <div className='flex flex-col justify-center items-center w-full h-full'>
          <div className='max-w-7xl w-full mx-auto px-4'>
            <div className='grid md:grid-cols-2 gap-16'>
              ...
              <div className='flex items-center justify-center min-h-[600px] order-2 md:order-1'>
              ...
              <div className='flex items-center justify-center min-h-[600px] order-1 md:order-2'>

  ...
  return (
    ...
    {/* Stars background */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className='flex flex-col lg:flex-row max-w-[1240px] w-full gap-10 lg:gap-16 items-center lg:items-start'>
            {/* Left side */}
            <div
              ref={leftAnim.ref}
              className={`lg:w-1/2 w-full scroll-hidden scroll-left ${leftAnim.isVisible ? 'scroll-visible' : ''}`}
            >
                ...
                <div className='space-y-4 max-w-[600px]'>
                    <a href="mailto:reyndoming@gmail.com" className='bg-[#11161D]/50 backdrop-blur-sm border border-gray-800 p-4 rounded-2xl flex items-center justify-between group cursor-pointer hover:bg-[#161B22] hover:border-gray-700 transition-all duration-300 shadow-lg shadow-black/20'>
                        <div className='flex items-center gap-4'>
                            <div className='w-14 h-14 bg-[#161B22] border border-gray-700 flex items-center justify-center rounded-xl group-hover:bg-[#1C2128] group-hover:border-gray-600 transition-all'>
                                <FiMail className='text-gray-400 text-lg group-hover:text-cyan-400 transition-colors' />
                            </div>
                            <div>
                                <p className='text-gray-500 text-sm uppercase tracking-wider font-semibold'>Email us</p>
                    ...
                    <a href="tel:09104673672" className='bg-[#11161D]/50 backdrop-blur-sm border border-gray-800 p-4 rounded-2xl flex items-center justify-between group cursor-pointer hover:bg-[#161B22] hover:border-gray-700 transition-all duration-300 shadow-lg shadow-black/20'>
                        <div className='flex items-center gap-4'>
                            <div className='w-14 h-14 bg-[#161B22] border border-gray-700 flex items-center justify-center rounded-xl group-hover:bg-[#1C2128] group-hover:border-gray-600 transition-all'>
                                <FiPhone className='text-gray-400 text-lg group-hover:text-cyan-400 transition-colors' />
                            </div>
                            <div>
                                <p className='text-gray-500 text-sm uppercase tracking-wider font-semibold'>Call me</p>
                    ...
                    <a href="https://www.google.com/maps/search/Phase+10+Block+2+Lot+34,+Coriander+Street,+Deca+Homes+Rd,+Mintal,+Davao+City,+Davao+del+Sur/@7.1135017,125.5046076,18.75z?entry=ttu&g_ep=EgoyMDI2MDIyMy4wIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noreferrer" className='bg-[#11161D]/50 backdrop-blur-sm border border-gray-800 p-4 rounded-2xl flex items-center justify-between group cursor-pointer hover:bg-[#161B22] hover:border-gray-700 transition-all duration-300 shadow-lg shadow-black/20'>
                        <div className='flex items-center gap-4'>
                            <div className='w-14 h-14 bg-[#161B22] border border-gray-700 flex items-center justify-center rounded-xl group-hover:bg-[#1C2128] group-hover:border-gray-600 transition-all'>
                                <FiMapPin className='text-gray-400 text-lg group-hover:text-cyan-400 transition-colors' />
                            </div>
                            <div>
                                <p className='text-gray-500 text-sm uppercase tracking-wider font-semibold'>My location</p>
                                <p className='text-white font-medium'>Deca Homes, Mintal, Davao City, Davao Delsur</p>
                            </div>
                        </div>
                        <FiArrowUpRight className='text-gray-600 text-xl group-hover:text-white group-hover:translate-x-1 group-hover:-translate-y-1 transition-all duration-300' />
                    </a>
